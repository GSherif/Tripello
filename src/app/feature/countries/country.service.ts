        ...
        this.data = [
            {
                ...
                cities: [...this.cities.getByCountryId(1)], rating: 5
            },
            {
                ...
                cities: [...this.cities.getByCountryId(2)], rating: null
            },
            {
                ...
                cities: [...this.cities.getByCountryId(3)], rating: null
            },
            {
                ...
                cities: [...this.cities.getByCountryId(4)], rating: null
            },
            {
                ...
                cities: [...this.cities.getByCountryId(5)], rating: null
            },
            {
                ...
                cities: [...this.cities.getByCountryId(6)], rating: null
            }
        ]
    }
    // [
